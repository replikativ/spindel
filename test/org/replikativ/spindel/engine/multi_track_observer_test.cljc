(ns org.replikativ.spindel.engine.multi-track-observer-test
  ...
  User-visible symptom in simmis: tracked signals like `kb-states` lost
  reactivity after the first re-render — pressing ENTER on a wiki page would
  not show the new block until full refresh.
