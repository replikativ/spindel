(ns org.replikativ.spindel.structural-id-test
  ...
  These tests pin down the property the simmis sidebar-duplication bug
...
;; =============================================================================
;; A pair of "component-like" factory functions, the simmis pattern.
;; =============================================================================
...
;; =============================================================================
;; Test 1: stable id across parent body re-runs (the simmis case)
;; =============================================================================
