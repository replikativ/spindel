(ns is.simm.spindel.distributed.macro-test
  "Tests for defn-spin-remote macro."
  (:require [clojure.test :refer [deftest is testing use-fixtures]]
            [is.simm.spindel.distributed.macros :refer [defn-spin-remote spin-remote]]
...
(deftest test-spin-remote-standalone-throws
  (testing "spin-remote throws when used outside defn-spin-remote"
    ...
    (is (thrown-with-msg? clojure.lang.ExceptionInfo
          ...
          (is.simm.spindel.distributed.macros/spin-remote
...
(def this-ns "is.simm.spindel.distributed.macro-test")
