           ...
           (let [counter (sig/signal 0)
             ...
             (let [checkpoint (ctx/snapshot-context ctx)]
               ...
               (let [restored-ctx (ctx/restore-snapshot checkpoint)]
                 (binding [rtc/*execution-context* restored-ctx]
                   (is (= 5 @counter))
                   (is (= ["spin-1"] @todos)))))))))))
         ...
         (binding [rtc/*execution-context* ctx-main]
           (let [value (sig/signal 10)]
             ...
             (let [snapshot (ctx/snapshot-context ctx-main)
               ...
               (binding [rtc/*execution-context* ctx-timeline-a]
                 (is (= 11 @value)))

               (binding [rtc/*execution-context* ctx-timeline-b]
                 (is (= 11 @value)))
               ...
               (let [snapshot-a (ctx/snapshot-context ctx-timeline-a)
                 ...
                 (binding [rtc/*execution-context* ctx-timeline-c]
                   (is (= 22 @value))
