(ns is.simm.spindel.spin.rate-control-test
  ...
  #?(:clj
     (:require [clojure.test :refer [deftest is testing use-fixtures]]
               ...
               [is.simm.spindel.spin.combinators :refer [debounce throttle sample relieve timeout sleep race accumulate]]
  ...
  #?(:clj (:require [is.simm.spindel.state.signal :refer [signal]])))
