(ns is.simm.spindel.spin.cps
  ...
  (:require [is.simm.spindel.runtime.core :as rtc]
            ...
            [is.simm.spindel.effects.core]
            [is.simm.spindel.effects.await]   ;; Load await effect handler
            [is.simm.spindel.effects.track]   ;; Load track effect handler
...
#?(:clj
   (defn ^:no-doc build-breakpoints
     ...
     []
     (let [reg (is.simm.spindel.effects.core/get-effect-syntax)
