(ns is.simm.spindel.runtime.bindings
...
(defn- get-vars-to-capture
  ...
  #?(:clj
     ...
     [(resolve 'is.simm.spindel.runtime.core/*spin-id*)
      (resolve 'is.simm.spindel.runtime.core/*worker-id*)
      (resolve 'is.simm.spindel.runtime.core/*yield-handler*)
      (resolve 'is.simm.spindel.runtime.core/*address-stack*)]
     :cljs
