(ns is.simm.spindel.incremental.deltaable
...
#?(:clj
   (do
     (defmethod print-method is.simm.spindel.incremental.deltaable.DeltaableVector [dv ^java.io.Writer w]
       (.write w (str (.-v dv))))
     (defmethod print-method is.simm.spindel.incremental.deltaable.DeltaableMap [dm ^java.io.Writer w]
       (.write w (str (.-m dm))))
     (defmethod print-method is.simm.spindel.incremental.deltaable.DeltaableSet [ds ^java.io.Writer w]
       (.write w (str (.-s ds))))))
