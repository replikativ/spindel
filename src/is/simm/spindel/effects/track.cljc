(ns is.simm.spindel.effects.track
  ...
  #?(:clj (:import [is.simm.spindel.state.signal SignalRef])))
...
(eff/register-effect-by-symbol!
  'is.simm.spindel.effects.track/track
  ::track-handler
  'is.simm.spindel.effects.core/one-arg->awaitable-map
  'is.simm.spindel.effects.track/track-handler)
