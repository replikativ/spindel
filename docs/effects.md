...
See [incremental.md](incremental.md) for the full typed delta algebra
...
by a track-resume. See [Cont-level cancellation gate](#cont-level-cancellation-gate) for the gate machinery; the
